...
Relational Databases are a type of database. SQL is the language use to query from certain
 relational databases.

- [ ] Why do tables need a `primary key`?
To make sure there is a unique address to the data in the table.
